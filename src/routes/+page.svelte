<script>
	import Flower from '$lib/map/Flower.svelte';
...
<div class="bg-white">
	<div>
		Radius <input type="range" bind:value={radius} min="0" max="10000" step="10" /> (radius: {radius /
			1000}
		km) (max_distance: {(radius * 2) / 1000} km)
	</div>
	<div>
